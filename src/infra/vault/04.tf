...
resource "vault_pki_secret_backend_config_urls" "int_04" {
  ...
  issuing_certificates    = ["https://${var.api_primary_domain_name}/intermediate/04/ca"]
  crl_distribution_points = ["https://${var.api_primary_domain_name}/intermediate/04/crl"]
}
